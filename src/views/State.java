...
public abstract class State implements IView {
    ...
    public List<Command> setCommands() {
        ...
        final Command command1 = new Command("exit", new LinkedList<String>(),
                this, "exit", "Quitte l'application");
        final Command command2 = new Command("help", new LinkedList<String>(),
                this, "printHelp", "Affiche l'aide");
