...
public class Administrator extends User {
    ...
    private void accept(final String id) {
        ...
        final model.person.Borrower.Borrow borrow = Inventory
                .findBorrowById(id);
        if (borrow == null) {
            this.printHelp();
            return;
     ...
     */
    @SuppressWarnings("unused")
    private void addEquipment(final String type, final String numb)
            throws MiniProjectException {
     ...
     */
    @SuppressWarnings("unused")
    private void equipmentHealth(final String id, final String healthState,
        ...
        final Health health = equipment.getHealth();
    ...
    @SuppressWarnings("unused")
    private void equipmentHealth(final String id, final String healthState,
            final String message, final boolean underRepair) {
    ...
    /**
     * Find equipment who need repair.
     */
    @SuppressWarnings("unused")
    ...
    public List<Command> setCommands() {
        ...
        final Command command8 = new Command("findEquipmentUnderRepair",
                new LinkedList<String>(), this, "findEquipmentUnderRepair",
                "Cherche les equipements en cours de reparation");
        final Command command9 = new Command(
                "findEquipmentWhoNeedRepair",
        ...
        args13.add("id");
        args13.add("password");
        final Command command13 = new Command("createUser", args13, this,
